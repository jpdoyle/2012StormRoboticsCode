...
// Customized AxisCamera to provide some helpful utility functions
...
public class AxisCamera implements ISensor {
    ...
    public void getImage(Image img) throws AxisCameraException, NIVisionException {
        if (getImageFn.call1(img.image) == 0) {
            throw new AxisCameraException("No image available");
        }
    }
